        ...
        measuredPixels: {
          ...
          items: {
            ...
            properties: {
              label: {
                type: "string",
                description: "Name of the feature being measured (e.g. cavity_length, tab_width)."
              },
              pixelSpan: {
                type: "number",
                description: "Pixel span of this feature measured in the image."
              }
            },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        outputDir: {
          type: "string",
          description: "Output directory for synthesized CAD files."
        },
        filename: {
          type: "string",
          description: "Base filename for generated files without extension."
        }
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        verbose: {
          type: "boolean",
          description: "Whether to return detailed system diagnostic info."
        }
      },
      required: []
    }
